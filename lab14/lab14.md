...
1. RegisterUser. Регистрирует нового пользователя по адресу его почты (email) и паролю.
   Т.е. email выступает в качестве логина пользователя.
...
Т.о. пользователь получит лишь один email после того, как закончит работать с сервисом:
